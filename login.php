...
<head>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('admin/assets/images/small/img-6.jpg');background-size: cover;background-position: center;"></div>
        ...
        <div class="wrapper-page account-page-full">
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright"><?=date('Y')?> © Khalid Shafi</p>
            </div>
