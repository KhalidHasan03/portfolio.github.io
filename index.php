                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                ...
                                <?php 
                                    ...
                                    $my_logo = $logo_query -> fetch_assoc();
                                ?>
                                    <a href="index.php" class="navbar-brand logo-sticky-none"><img src="<?= $logo['photo']?>/20.jpg" alt="Logo"></a>
                                    <a href="index.php" class="navbar-brand s-logo-none"><img src="<?= $logo['photo']; ?>/20.jpg" alt="Logo"></a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <img src="admin/image/profile/<?=$about_me['photo']?>" height="630px" width="500px" class="ml-3 mt-3" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="about" class="about-area primary-bg pt-120 pb-120">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about-img">
                                <img src="admin/image/profile/2.jpg" height="600px" width="450px" class="mt-5" title="me-01" alt="me-01">
                            </div>
                        </div>
                    ...
                    ?>
                      ...
                      <div class="speaker-box">
      								<div class="speaker-thumb">
      									<img src="admin/image/my_best_works/<?=$row['photo']?>" height="220px" alt="img" >
      								</div>
            ...
            <div class="barnd-area pt-100 pb-100">
                <div class="container">
                    <div class="row brand-active">
                      ...
                      <?php 
                      $logo_query = $dbcon->query("SELECT * FROM logo ORDER BY id DESC LIMIT 8");
                      if($logo_query->num_rows){
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="copyright-text text-center">
                                <p>Copyright© || <span>Khalid Shafi</span> || All Rights Reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
